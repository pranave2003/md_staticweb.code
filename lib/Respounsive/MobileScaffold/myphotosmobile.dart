...
class MyPhotos_mobile extends StatefulWidget {
  const MyPhotos_mobile({Key? key}) : super(key: key);

  @override
  State<MyPhotos_mobile> createState() => _MyPhotos_mobileState();
}

class _MyPhotos_mobileState extends State<MyPhotos_mobile> {
